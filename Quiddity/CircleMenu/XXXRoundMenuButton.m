...
- (UIColor*)add_darkerColorWithValue:(CGFloat)value origin:(UIColor*)origin
{
    ...
    return retColor;
    // MARK: - Open menu Plus button color
}
...
- (void)setMainColor:(UIColor *)mainColor
{
    ...
    self.roundCircle.circleColor = [UIColor clearColor];
}
...
- (void)layoutSubviews
{
    ...
    if (self.selected) {
        ...
        self.roundCircle.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.7];
    }
    else
    {
...
//    MARK: - Draw Plus Button
    if (self.type == XXXIconTypePlus || self.state == UIControlStateSelected) {
        //// Rectangle Drawing
        UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(20, rect.size.height/2 - 2, rect.size.width - 40, 4)];
        [UIColor.whiteColor setFill];
        [rectanglePath fill];
        
        
        //// Rectangle 2 Drawing
        UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRect: CGRectMake(rect.size.width/2 - 2, 20, 4, rect.size.height - 40)];
        [UIColor.whiteColor setFill];
        [rectangle2Path fill];
    }
...
//        MARK - Set other icon sizes
        ...
        if([[UIScreen mainScreen] bounds].size.width == 320) {
            ...
            button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 70, 70)];
            button.layer.cornerRadius = 35;
        } else {
            button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 77, 77)];
